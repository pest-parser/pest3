...
mod trivia {
    pub type OptionalTrivia<'i> = super::generics::Rep<
        super::generics::Choice2<super::rules::r#whitespace<'i>, super::rules::r#comment<'i>>,
        0u8,
    >;
    pub type MandatoryTrivia<'i> = super::generics::Rep<
        super::generics::Choice2<super::rules::r#whitespace<'i>, super::rules::r#comment<'i>>,
        0u8,
    >;
}
...
pub mod rules {
    ...
    pub struct r#ident<'i> {
        #[doc = r" Matched structure."]
        pub content: super::rules::r#string<'i>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#ident<'i> {
        type Inner = super::rules::r#string<'i>;
        type Content = super::rules::r#string<'i>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#pos_pred<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::Positive<super::rules::r#string<'i>>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#pos_pred<'i> {
        type Inner = super::generics::Positive<super::rules::r#string<'i>>;
        type Content = super::generics::Positive<super::rules::r#string<'i>>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#neg_pred<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::Negative<super::rules::r#string<'i>>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#neg_pred<'i> {
        type Inner = super::generics::Negative<super::rules::r#string<'i>>;
        type Content = super::generics::Negative<super::rules::r#string<'i>>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#double_neg_pred<'i> {
        #[doc = r" Matched structure."]
        pub content:
            super::generics::Negative<super::generics::Negative<super::rules::r#string<'i>>>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    pub struct r#choice<'i> {
        #[doc = r" Matched structure."]
        pub content:
            super::generics::Choice2<super::rules::r#string<'i>, super::rules::r#range<'i>>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    pub struct r#optional<'i> {
        #[doc = r" Matched structure."]
        pub content: ::pest3::std::Option<super::rules::r#string<'i>>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#optional<'i> {
        type Inner = ::pest3::std::Option<super::rules::r#string<'i>>;
        type Content = ::pest3::std::Option<super::rules::r#string<'i>>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::Rep<super::rules::r#string<'i>, 0u8>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat<'i> {
        type Inner = super::generics::Rep<super::rules::r#string<'i>, 0u8>;
        type Content = super::generics::Rep<super::rules::r#string<'i>, 0u8>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_trivia<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::Rep<super::rules::r#string<'i>, 1u8>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_trivia<'i> {
        type Inner = super::generics::Rep<super::rules::r#string<'i>, 1u8>;
        type Content = super::generics::Rep<super::rules::r#string<'i>, 1u8>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_trivia_mandatory<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::Rep<super::rules::r#string<'i>, 2u8>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_trivia_mandatory<'i> {
        type Inner = super::generics::Rep<super::rules::r#string<'i>, 2u8>;
        type Content = super::generics::Rep<super::rules::r#string<'i>, 2u8>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_once<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepOnce<super::rules::r#string<'i>, 0u8>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_once<'i> {
        type Inner = super::generics::RepOnce<super::rules::r#string<'i>, 0u8>;
        type Content = super::generics::RepOnce<super::rules::r#string<'i>, 0u8>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_once_trivia<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepOnce<super::rules::r#string<'i>, 1u8>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_once_trivia<'i> {
        type Inner = super::generics::RepOnce<super::rules::r#string<'i>, 1u8>;
        type Content = super::generics::RepOnce<super::rules::r#string<'i>, 1u8>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_once_trivia_mandatory<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepOnce<super::rules::r#string<'i>, 2u8>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_once_trivia_mandatory<'i> {
        type Inner = super::generics::RepOnce<super::rules::r#string<'i>, 2u8>;
        type Content = super::generics::RepOnce<super::rules::r#string<'i>, 2u8>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_min_max<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMinMax<super::rules::r#string<'i>, 0u8, 2usize, 3usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_min_max<'i> {
        type Inner = super::generics::RepMinMax<super::rules::r#string<'i>, 0u8, 2usize, 3usize>;
        type Content = super::generics::RepMinMax<super::rules::r#string<'i>, 0u8, 2usize, 3usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_min_max_trivia<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMinMax<super::rules::r#string<'i>, 1u8, 2usize, 3usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_min_max_trivia<'i> {
        type Inner = super::generics::RepMinMax<super::rules::r#string<'i>, 1u8, 2usize, 3usize>;
        type Content = super::generics::RepMinMax<super::rules::r#string<'i>, 1u8, 2usize, 3usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_min_max_trivia_mandatory<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMinMax<super::rules::r#string<'i>, 2u8, 2usize, 3usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_min_max_trivia_mandatory<'i> {
        type Inner = super::generics::RepMinMax<super::rules::r#string<'i>, 2u8, 2usize, 3usize>;
        type Content = super::generics::RepMinMax<super::rules::r#string<'i>, 2u8, 2usize, 3usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_exact<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMinMax<super::rules::r#string<'i>, 0u8, 2usize, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_exact<'i> {
        type Inner = super::generics::RepMinMax<super::rules::r#string<'i>, 0u8, 2usize, 2usize>;
        type Content = super::generics::RepMinMax<super::rules::r#string<'i>, 0u8, 2usize, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_exact_trivia<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMinMax<super::rules::r#string<'i>, 1u8, 2usize, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_exact_trivia<'i> {
        type Inner = super::generics::RepMinMax<super::rules::r#string<'i>, 1u8, 2usize, 2usize>;
        type Content = super::generics::RepMinMax<super::rules::r#string<'i>, 1u8, 2usize, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_exact_trivia_mandatory<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMinMax<super::rules::r#string<'i>, 2u8, 2usize, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_exact_trivia_mandatory<'i> {
        type Inner = super::generics::RepMinMax<super::rules::r#string<'i>, 2u8, 2usize, 2usize>;
        type Content = super::generics::RepMinMax<super::rules::r#string<'i>, 2u8, 2usize, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_min<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMin<super::rules::r#string<'i>, 0u8, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_min<'i> {
        type Inner = super::generics::RepMin<super::rules::r#string<'i>, 0u8, 2usize>;
        type Content = super::generics::RepMin<super::rules::r#string<'i>, 0u8, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_min_trivia<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMin<super::rules::r#string<'i>, 1u8, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_min_trivia<'i> {
        type Inner = super::generics::RepMin<super::rules::r#string<'i>, 1u8, 2usize>;
        type Content = super::generics::RepMin<super::rules::r#string<'i>, 1u8, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_min_trivia_mandatory<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMin<super::rules::r#string<'i>, 2u8, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_min_trivia_mandatory<'i> {
        type Inner = super::generics::RepMin<super::rules::r#string<'i>, 2u8, 2usize>;
        type Content = super::generics::RepMin<super::rules::r#string<'i>, 2u8, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_max<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMax<super::rules::r#string<'i>, 0u8, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_max<'i> {
        type Inner = super::generics::RepMax<super::rules::r#string<'i>, 0u8, 2usize>;
        type Content = super::generics::RepMax<super::rules::r#string<'i>, 0u8, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_max_trivia<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMax<super::rules::r#string<'i>, 1u8, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_max_trivia<'i> {
        type Inner = super::generics::RepMax<super::rules::r#string<'i>, 1u8, 2usize>;
        type Content = super::generics::RepMax<super::rules::r#string<'i>, 1u8, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_max_trivia_mandatory<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::RepMax<super::rules::r#string<'i>, 2u8, 2usize>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#repeat_max_trivia_mandatory<'i> {
        type Inner = super::generics::RepMax<super::rules::r#string<'i>, 2u8, 2usize>;
        type Content = super::generics::RepMax<super::rules::r#string<'i>, 2u8, 2usize>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#seperated_call<'i> {
        #[doc = r" Matched structure."]
        pub content: super::rules::r#seperated<'i, super::rules::r#string<'i>>,
        #[doc = r" Matched span."]
        pub span: ::pest3::Span<'i>,
    }
    #[allow(non_camel_case_types)]
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#seperated_call<'i> {
        type Inner = super::rules::r#seperated<'i, super::rules::r#string<'i>>;
        type Content = super::rules::r#seperated<'i, super::rules::r#string<'i>>;
        #[inline]
        fn new(
            content: <Self as ::pest3::typed::FullRuleStruct<'i>>::Content,
            span: ::pest3::Span<'i>,
    ...
    pub struct r#repeat_mutate_stack<'i> {
        ...
        pub content: super::generics::Sequence4<
            super::generics::Rep<
                super::generics::Sequence2<
                    super::rules::r#push<'i, super::generics::CharRange<'a', 'c'>>,
                    0u8,
    ...
    pub struct r#will_fail<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::Sequence2<
            super::rules::r#repeat_mutate_stack_pop_all<'i>,
            0u8,
    ...
    impl<'i> ::pest3::typed::FullRuleStruct<'i> for r#stack_resume_after_fail<'i> {
        type Inner = super::generics::Choice2<
            super::rules::r#will_fail<'i>,
            super::rules::r#repeat_mutate_stack_pop_all<'i>,
        >;
        type Content = super::generics::Choice2<
            super::rules::r#will_fail<'i>,
            super::rules::r#repeat_mutate_stack_pop_all<'i>,
        >;
        #[inline]
    ...
    pub struct r#peek_<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::Sequence4<
            super::rules::r#push<'i, super::rules::r#range<'i>>,
            0u8,
            super::rules::r#push<'i, super::rules::r#range<'i>>,
            1u8,
    ...
    pub struct r#pop_fail<'i> {
        ...
        pub content: super::generics::Sequence4<
            super::rules::r#push<'i, super::rules::r#range<'i>>,
            0u8,
            super::generics::Negative<super::rules::r#pop<'i>>,
            1u8,
            super::rules::r#range<'i>,
            1u8,
            super::rules::r#pop<'i>,
            1u8,
        >,
    ...
    pub struct r#checkpoint_restore<'i> {
        #[doc = r" Matched structure."]
        pub content: super::generics::Sequence3<
            super::rules::r#push<'i, super::generics::Str<super::wrapper::W3>>,
            0u8,
            super::generics::Choice3<
                super::generics::Sequence3<
                    super::rules::r#push<'i, super::generics::Str<super::wrapper::W4>>,
                    0u8,
